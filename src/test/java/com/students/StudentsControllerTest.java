...
class StudentsControllerTest {
	...
	public void getStudentTestWithInvalidId() throws Exception {
		...
		ResultActions resultActions = this.mockMvc.perform(get("/students/1")).andDo(print())
		...
		assertTrue(CommonConstants.INVALID_DATA.equalsIgnoreCase(
				resposeNode.get(CommonConstants.ERRORS).get(0).get(CommonConstants.ERRORCODE).asText()));

		assertTrue(resposeNode.get(CommonConstants.ERRORS).get(0).has(CommonConstants.MESSAGE));

		assertTrue("Student not available".equalsIgnoreCase(
				resposeNode.get(CommonConstants.ERRORS).get(0).get(CommonConstants.MESSAGE).asText()));
	}
	...
	public void addStudentTest() throws Exception {
		...
		ResultActions resultActions = this.mockMvc
				.perform(post("/students").contentType(MediaType.APPLICATION_JSON).content(
						"{ \"name\": \"Steve\", \"dateOfBirth\": \"1994-08-02\", \"address\": \"vicky addr\", \"gender\": \"male\", \"contactNumber\": 90431900353, \"sports\": \"abc\", \"curriculums\": \"abc\" }"))
		...
		JsonNode resposeNode = new ObjectMapper().readTree(contentAsString);

		assertTrue(CommonConstants.SUCCESS.equalsIgnoreCase(resposeNode.get(CommonConstants.RESPONSE).asText()));

		assertTrue(resposeNode.has("data"));
	...
	public void editStudentTest() throws Exception {
		...
		ResultActions resultActions = this.mockMvc
				.perform(put("/students/1001").contentType(MediaType.APPLICATION_JSON).content(
						"{ \"name\": \"Steve\", \"dateOfBirth\": \"1994-08-02\", \"address\": \"vicky addr\", \"gender\": \"male\", \"contactNumber\": 90431900353, \"sports\": \"abc\", \"curriculums\": \"abc\" }"))
				.andDo(print()).andExpect(status().isOk());
	...
	public void deleteStudentTest() throws Exception {
		...
		ResultActions resultActions = this.mockMvc.perform(delete("/students/1020")).andDo(print())
